...
public class ManHinhBanVe extends JPanel {
    ...
    private JPanel createMainContentPanel() {
        ...
        contentLeftPanel.add(createKhuVucDanhSachChuyenTau()); // Khu vực 2 (Đổi vị trí lên trên)
        contentLeftPanel.add(Box.createVerticalStrut(10));
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.weightx = 0.55; // Cột trái chiếm 55%
        gbc.weighty = 1.0;
        ...
        gbc.gridx = 1;
        gbc.weightx = 0.45; // Cột phải chiếm 45%
    ...
    private JPanel createKhuVucDanhSachChuyenTau() {
        ...
        // Đặt kích thước cố định cho khu vực này (nếu cần)
