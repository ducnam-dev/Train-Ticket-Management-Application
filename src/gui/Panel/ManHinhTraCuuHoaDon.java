...
//    // Làm rỗng bảng danh sách hoóa đơn
    ...
    private void btn_TraCuuActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (ComboBox_DanhMucTimKiem.getSelectedItem().equals("Mã hóa đơn")) {
            ...
            KhachHang khachhangNew = KhachHangDAO2.timKhachHangTheoMaHoaDon(giaTriTimKiem);
            ChuyenTau chuyenTauNew = ChuyenTauDao2.timKiemChuyenTauTheoMaHoaDon(giaTriTimKiem);
            int soLuongVe = ChiTietHoaDonDAO.demSoLuongVeTheoMaHoaDon(giaTriTimKiem);

//            hoaDonNew.getMaHoaDon();
...
//            hoaDonNew.getLoaiHoaDon();
        ...
        // TÌM HÓA ĐƠN THEO SỐ ĐIỆN THOẠI
            ...
            ArrayList<ChuyenTau> chuyenTauKetQua = ChuyenTauDao2.timKiemChuyenTauTheoSoDienThoai(giaTriTimKiem);
            ArrayList<KhachHang> khachHangKetQua = KhachHangDAO2.timKhachHangTheoSoDienThoai(giaTriTimKiem);
...
//            }
            ...
            for (int i = 0; i < hoaDonKetQua.size(); i++) {
                ...
                int soLuongVe = ChiTietHoaDonDAO.demSoLuongVeTheoMaHoaDon(hd.getMaHoaDon());
        ...
        // TÌM HÓA ĐƠN THEO SỐ CCCD
            ...
            ArrayList<KhachHang> khachHangKetQua = KhachHangDAO2.timKhachHangTheoCCCD(giaTriTimKiem);
            ArrayList<ChuyenTau> chuyenTauKetQua = ChuyenTauDao2.timChuyenTauTheoCCCD(giaTriTimKiem); // Giả sử tên phương thức này đúng
    ...
    private void btnFilter1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            if ("Số điện thoại".equals(loaiTimKiem)) {
                ...
                khachHangKetQua = KhachHangDAO2.timKhachHangTheoSDTLocThangNam(giaTriTimKiem, selectedMonthInt, selectedYearInt);
                chuyenTauKetQua = ChuyenTauDao2.timChuyenTauTheoSDTLocThangNam(giaTriTimKiem, selectedMonthInt, selectedYearInt);
                ...
                khachHangKetQua = KhachHangDAO2.timKhachHangTheoCCCDLocThangNam(giaTriTimKiem, selectedMonthInt, selectedYearInt);
                chuyenTauKetQua = ChuyenTauDao2.timChuyenTauTheoCCCDLocThangNam(giaTriTimKiem, selectedMonthInt, selectedYearInt);
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        for (int i = 0; i < hoaDonKetQua.size(); i++) { // Loop based on hoaDonKetQua size
            ...
            int soLuongVe = 0;
            try {
                soLuongVe = ChiTietHoaDonDAO.demSoLuongVeTheoMaHoaDon(hd.getMaHoaDon()); // Assuming this DAO method exists
            } catch (Exception e){
                System.err.println("Lỗi khi lấy số lượng vé cho HĐ " + hd.getMaHoaDon() + ": " + e.getMessage());
            }
